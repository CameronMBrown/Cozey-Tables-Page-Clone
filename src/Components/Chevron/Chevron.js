...
function Chevron({ menuState, menuStateHandler }) {
   return ( 
      <svg onClick={menuStateHandler} className={"chevron " + (menuState ? "open" : "closed")} height="25px" width="25px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 185.343 185.343" fill="#FFFFFF" stroke="#FFFFFF">
